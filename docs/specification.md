...
7) <VAR_DECLARATION> -> <VAR_TYPE> double_dot id semicolon <VAR_DECLARATION>
8) <VAR_DECLARATION> -> ε
9) <VAR_TYPE> -> boolean
10) <VAR_TYPE> -> double
11) <VAR_TYPE> -> string
12) <SIZE_DECLARATION> -> open_size_string number close_size_string
...
18) <BODY_STATEMENT> -> stop <BODY_STATEMENT'>
19) <BODY_STATEMENT> -> <PRINT_STATEMENT> <BODY_STATEMENT'>
20) <BODY_STATEMENT> -> <SCAN_STATEMENT> <BODY_STATEMENT'>
21) <BODY_STATEMENT> -> <INC_STATEMENT> <BODY_STATEMENT'>
22) <BODY_STATEMENT> -> <DEC_STATEMENT> <BODY_STATEMENT'>
23) <BODY_STATEMENT> -> ε
24) <BODY_STATEMENT'> -> semicolon <BODY_STATEMENT>
25) <WHILE_STATEMENT> -> while open_par <LOGICAL_STATEMENT> <WHILE_STATEMENT'>
26) <WHILE_STATEMENT> -> while open_par <OPERATOR> <WHILE_STATEMENT'>
27) <WHILE_STATEMENT'> -> close_par open_braces <BODY_STATEMENT> close_braces
28) <INC_STATEMENT> -> id inc
29) <DEC_STATEMENT> -> id dec
30) <DO_WHILE_STATEMENT> -> do open_braces <BODY_STATEMENT> close_braces while open_par <DO_WHILE_STATEMENT'>
31) <DO_WHILE_STATEMENT'> -> <LOGICAL_STATEMENT> close_par
32) <DO_WHILE_STATEMENT'> -> <OPERATOR> close_par
33) <IF_STATEMENT> -> if open_par <IF_STATEMENT'>
34) <IF_STATEMENT'> -> <LOGICAL_STATEMENT> <IF_STATEMENT''>
35) <IF_STATEMENT'> -> <RELATIONAL_STATEMENT> <IF_STATEMENT''>
36) <IF_STATEMENT'> -> <OPERATOR> <IF_STATEMENT''>
37) <IF_STATEMENT''> -> close_par open_braces <BODY_STATEMENT> close_braces <ELSE_IF_STATEMENT> <ELSE_STATEMENT>
38) <ELSE_IF_STATEMENT> -> else if open_par <ELSE_IF_STATEMENT'>
39) <ELSE_IF_STATEMENT> -> ε
40) <ELSE_IF_STATEMENT'> -> <LOGICAL_STATEMENT> <ELSE_IF_STATEMENT''>
41) <ELSE_IF_STATEMENT'> -> <RELATIONAL_STATEMENT> <ELSE_IF_STATEMENT''>
42) <ELSE_IF_STATEMENT'> -> <OPERATOR> <ELSE_IF_STATEMENT''>
43) <ELSE_IF_STATEMENT''> -> close_par open_braces <BODY_STATEMENT> close_braces <ELSE_IF_STATEMENT>
44) <ELSE_STATEMENT> -> else open_braces <BODY_STATEMENT> close_braces
45) <ELSE_STATEMENT> -> ε
46) <SWITCH_STATEMENT> -> switch open_par id close_par open_braces <CASE_STATEMENT> close_braces
47) <CASE_STATEMENT> -> case <OPERATOR> double_dot <BODY_STATEMENT> <CASE_STATEMENT>
48) <CASE_STATEMENT> -> dflt double_dot <BODY_STATEMENT>
49) <CASE_STATEMENT> -> ε 
50) <SCAN_STATEMENT> -> scan open_par id close_par
51) <OPERATOR> -> number
52) <OPERATOR> -> id
53) <OPERATOR> -> string_value
54) <PRINT_STATEMENT> -> print open_par <OPERATOR> close_par
55) <LOGICAL_STATEMENT> -> <OPERATOR> <LOGICAL_STATEMENT'>
56) <LOGICAL_STATEMENT> -> not <OPERATOR>
57) <LOGICAL_STATEMENT'> -> and <OPERATOR>
58) <LOGICAL_STATEMENT'> -> or <OPERATOR>
59) <LOGICAL_STATEMENT'> -> xor <OPERATOR>
60) <RELATIONAL_STATEMENT> -> <OPERATOR> <RELATIONAL_STATEMENT'>
61) <RELATIONAL_STATEMENT'> -> equal <OPERATOR>
62) <RELATIONAL_STATEMENT'> -> bigger <OPERATOR>
63) <RELATIONAL_STATEMENT'> -> less <OPERATOR>
64) <RELATIONAL_STATEMENT'> -> bigger_eq <OPERATOR>
65) <RELATIONAL_STATEMENT'> -> less_eq <OPERATOR>
66) <RELATIONAL_STATEMENT'> -> dif <OPERATOR>
67) <ARITHMETIC_STATEMENT> -> <OPERATOR> <ARITHMETIC_STATEMENT'>
68) <ARITHMETIC_STATEMENT'> -> sum <OPERATOR>
69) <ARITHMETIC_STATEMENT'> -> sub <OPERATOR>
70) <ARITHMETIC_STATEMENT'> -> mult <OPERATOR>
71) <ARITHMETIC_STATEMENT'> -> div <OPERATOR>
72) <ATTRIBUTION_STATEMENT> -> id att <ATTRIBUTION_STATEMENT'>
73) <ATTRIBUTION_STATEMENT'> -> <OPERATOR>
74) <ATTRIBUTION_STATEMENT'> -> <ARITHMETIC_STATEMENT>
75) <ATTRIBUTION_STATEMENT'> -> <LOGICAL_STATEMENT>
76) <ATTRIBUTION_STATEMENT'> -> <RELATIONAL_STATEMENT>
```
