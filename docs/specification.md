...
<VAR_DECLARATION> -> <VAR_TYPE> <DOUBLE_DOT> <EXPRESSION_NAME> <SIZE_DECLARATION> <SEMICOLON> <VAR_DECLARATION> | ε
...
<EXPRESSION_DIGIT> -> [1-9]⁺[0-9]*
<SIZE_DECLARATION> -> <OPEN_SIZE_STRING> <EXPRESSION_DIGIT> <CLOSE_SIZE_STRING> | ε
<OPEN_SIZE_STRING> -> [
<CLOSE_SIZE_STRING> -> ]
...
<STOP> -> STOP
<CONDITION> -> <OPEN_PAR> <OPERATING> <CLOSE_PAR>
<WHILE> -> WHILE
...
<SWITCH_STATEMENT> -> <SWITCH> <OPEN_PAR> <EXPRESSION_NAME> <CLOSE_PAR> <OPEN_BRACES> <CASE_STATEMENT> <CLOSE_BRACES>
<OPEN_PAR> -> (
<CLOSE_PAR> -> )
<PRINT_STATEMENT> -> PRINT <OPEN_PAR> <STR> <CLOSE_PAR>
<SCAN_STATEMENT> -> SCAN <OPEN_PAR> <ID> <CLOSE_PAR>
<SWITCH> -> SWITCH
<CASE_STATEMENT> -> <CASE> <EXPRESSION_NAME> <DOUBLE_DOT> <BODY STATEMENT> <CASE_STATEMENT> | <DFLT> <DOUBLE_DOT> <BODY STATEMENT> |  ε
<DFLT> -> DFLT
<CASE> -> CASE
<VALUE> -> <BOOLEAN_VALUE> | <DOUBLE_VALUE> | <STRING_VALUE>
