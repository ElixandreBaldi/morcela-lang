...
<LOGICAL_STATEMENT> -> <OPERATOR_BOOLEAN> and <OPERATOR_BOOLEAN> │ <OPERATOR_BOOLEAN> or <OPERATOR_BOOLEAN> │ <OPERATOR_BOOLEAN> xor <OPERATOR_BOOLEAN> │ not <OPERATOR_BOOLEAN>
<RELATIONAL_STATEMENT> -> <OPERATOR> equal <OPERATOR> | <OPERATOR> bigger <OPERATOR> │ <OPERATOR> less <OPERATOR> │ <OPERATOR> bigger_eq <OPERATOR> │ <OPERATOR> less_eq <OPERATOR> | <OPERATOR> dif <OPERATOR> )
<OPERATOR_ARITHMETIC> -> <ARITHMETIC_STATEMENT> | id | num
<ARITHMETIC_STATEMENT> -> <OPERATOR_ARITHMETIC> sum <OPERATOR_ARITHMETIC> │ <OPERATOR_ARITHMETIC> sub <OPERATOR_ARITHMETIC> │ <OPERATOR_ARITHMETIC> mult <OPERATOR_ARITHMETIC> │ <OPERATOR_ARITHMETIC> div <OPERATOR_ARITHMETIC> | id
