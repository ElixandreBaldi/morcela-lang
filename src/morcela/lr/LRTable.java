...
public class LRTable extends HashMap<Integer, HashMap<Operable, Action>> {
    ...
    public static LRTable getInstance() {
        ...
        actions.put(TokenType.INC, new ShiftAction(37));
        actions.put(TokenType.DEC, new ShiftAction(38));
        ...
        actions.put(NonTerminal.STOP_STATEMENT, new GotoAction(24));
        ...
        // State 14
        actions = new HashMap<>();
        actions.put(TokenType.DOUBLE_DOT, new ShiftAction(40));
        ...
        // State 18
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ShiftAction(41));
        ...
        actions.put(TokenType.PRINT, new ShiftAction(35));
        actions.put(TokenType.SCAN, new ShiftAction(36));
        actions.put(NonTerminal.BODY_STATEMENT, new GotoAction(48));
        actions.put(NonTerminal.WHILE_STATEMENT, new GotoAction(21));
        actions.put(NonTerminal.STOP_STATEMENT, new GotoAction(24));
        actions.put(NonTerminal.INC_STATEMENT, new GotoAction(27));
        actions.put(NonTerminal.DEC_STATEMENT, new GotoAction(28));
        ...
        actions.put(TokenType.PRINT, new ShiftAction(35));
        actions.put(TokenType.SCAN, new ShiftAction(36));
        actions.put(NonTerminal.BODY_STATEMENT, new GotoAction(49));
        actions.put(NonTerminal.WHILE_STATEMENT, new GotoAction(21));
        actions.put(NonTerminal.STOP_STATEMENT, new GotoAction(24));
        actions.put(NonTerminal.INC_STATEMENT, new GotoAction(27));
        actions.put(NonTerminal.DEC_STATEMENT, new GotoAction(28));
        ...
        actions.put(TokenType.PRINT, new ShiftAction(35));
        actions.put(TokenType.SCAN, new ShiftAction(36));
        actions.put(NonTerminal.BODY_STATEMENT, new GotoAction(50));
        actions.put(NonTerminal.WHILE_STATEMENT, new GotoAction(21));
        actions.put(NonTerminal.STOP_STATEMENT, new GotoAction(24));
        actions.put(NonTerminal.INC_STATEMENT, new GotoAction(27));
        actions.put(NonTerminal.DEC_STATEMENT, new GotoAction(28));
        ...
        actions.put(TokenType.PRINT, new ShiftAction(35));
        actions.put(TokenType.SCAN, new ShiftAction(36));
        actions.put(NonTerminal.BODY_STATEMENT, new GotoAction(51));
        actions.put(NonTerminal.WHILE_STATEMENT, new GotoAction(21));
        actions.put(NonTerminal.STOP_STATEMENT, new GotoAction(24));
        actions.put(NonTerminal.INC_STATEMENT, new GotoAction(27));
        actions.put(NonTerminal.DEC_STATEMENT, new GotoAction(28));
        ...
        // State 30
        actions = new HashMap<>();
        actions.put(TokenType.OPEN_PAR, new ShiftAction(54));
        actions.put(NonTerminal.CONDITION, new GotoAction(53));
        ...
        actions = new HashMap<>();
        actions.put(TokenType.OPEN_PAR, new ShiftAction(54));
        actions.put(NonTerminal.CONDITION, new GotoAction(55));
        table.put(31, actions);


        // State 32
        actions = new HashMap<>();
        actions.put(TokenType.OPEN_BRACES, new ShiftAction(56));
        table.put(32, actions);


        // State 33
        actions = new HashMap<>();
        actions.put(TokenType.ATT, new ShiftAction(57));
        table.put(33, actions);


        // State 34
        actions = new HashMap<>();
        actions.put(TokenType.SEMICOLON, new ShiftAction(58));
        table.put(34, actions);


        // State 35
        actions = new HashMap<>();
        actions.put(TokenType.OPEN_PAR, new ShiftAction(59));
        table.put(35, actions);


        // State 36
        actions = new HashMap<>();
        actions.put(TokenType.OPEN_PAR, new ShiftAction(60));
        table.put(36, actions);


        // State 37
        actions = new HashMap<>();
        actions.put(TokenType.SEMICOLON, new ShiftAction(61));
        table.put(37, actions);


        // State 38
        actions = new HashMap<>();
        actions.put(TokenType.SEMICOLON, new ShiftAction(62));
        ...
        // State 52
        actions = new HashMap<>();
        actions.put(TokenType.ID, new ShiftAction(64));
        table.put(52, actions);


        // State 53
        actions = new HashMap<>();
        actions.put(TokenType.OPEN_BRACES, new ShiftAction(65));
        table.put(53, actions);


        // State 54
        actions = new HashMap<>();
        actions.put(TokenType.ID, new ShiftAction(69));
        actions.put(TokenType.NUM, new ShiftAction(72));
        actions.put(NonTerminal.OPERATOR, new GotoAction(70));
        actions.put(NonTerminal.OPERATOR_BOOLEAN, new GotoAction(66));
        actions.put(NonTerminal.LOGICAL_STATEMENT, new GotoAction(68));
        actions.put(NonTerminal.RELATIONAL_STATEMENT, new GotoAction(67));
        actions.put(NonTerminal.ARITHMETIC_STATEMENT, new GotoAction(71));
        table.put(54, actions);


        // State 55
        actions = new HashMap<>();
        actions.put(TokenType.OPEN_BRACES, new ShiftAction(73));
        ...
        actions.put(TokenType.PRINT, new ShiftAction(35));
        actions.put(TokenType.SCAN, new ShiftAction(36));
        actions.put(NonTerminal.BODY_STATEMENT, new GotoAction(74));
        actions.put(NonTerminal.WHILE_STATEMENT, new GotoAction(21));
        actions.put(NonTerminal.STOP_STATEMENT, new GotoAction(24));
        actions.put(NonTerminal.INC_STATEMENT, new GotoAction(27));
        actions.put(NonTerminal.DEC_STATEMENT, new GotoAction(28));
        ...
        actions.put(NonTerminal.OPERATOR_BOOLEAN, new GotoAction(76));
        actions.put(NonTerminal.LOGICAL_STATEMENT, new GotoAction(68));
        actions.put(NonTerminal.RELATIONAL_STATEMENT, new GotoAction(67));
        actions.put(NonTerminal.ARITHMETIC_STATEMENT, new GotoAction(71));
        ...
        // State 58
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ReduceAction(25));
        ...
        actions.put(TokenType.INC, new ReduceAction(25));
        actions.put(TokenType.DEC, new ReduceAction(25));
        ...
        actions.put(TokenType.CASE, new ReduceAction(25));
        actions.put(TokenType.DFLT, new ReduceAction(25));
        ...
        // State 59
        actions = new HashMap<>();
        actions.put(TokenType.STRING_VALUE, new ShiftAction(77));
        table.put(59, actions);


        // State 60
        actions = new HashMap<>();
        actions.put(TokenType.ID, new ShiftAction(78));
        table.put(60, actions);


        // State 61
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ReduceAction(26));
        ...
        actions.put(TokenType.INC, new ReduceAction(26));
        actions.put(TokenType.DEC, new ReduceAction(26));
        ...
        actions.put(TokenType.CASE, new ReduceAction(26));
        actions.put(TokenType.DFLT, new ReduceAction(26));
        ...
        // State 62
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ReduceAction(27));
        actions.put(TokenType.ID, new ReduceAction(27));
        actions.put(TokenType.WHILE, new ReduceAction(27));
        actions.put(TokenType.STOP, new ReduceAction(27));
        actions.put(TokenType.INC, new ReduceAction(27));
        actions.put(TokenType.DEC, new ReduceAction(27));
        actions.put(TokenType.DO, new ReduceAction(27));
        actions.put(TokenType.IF, new ReduceAction(27));
        actions.put(TokenType.SWITCH, new ReduceAction(27));
        actions.put(TokenType.CASE, new ReduceAction(27));
        actions.put(TokenType.DFLT, new ReduceAction(27));
        actions.put(TokenType.PRINT, new ReduceAction(27));
        actions.put(TokenType.SCAN, new ReduceAction(27));
        ...
        actions.put(TokenType.OPEN_SIZE_STRING, new ShiftAction(80));
        actions.put(NonTerminal.SIZE_DECLARATION, new GotoAction(79));
        table.put(63, actions);


        // State 64
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_PAR, new ShiftAction(81));
        ...
        actions.put(TokenType.PRINT, new ShiftAction(35));
        actions.put(TokenType.SCAN, new ShiftAction(36));
        actions.put(NonTerminal.BODY_STATEMENT, new GotoAction(82));
        actions.put(NonTerminal.WHILE_STATEMENT, new GotoAction(21));
        actions.put(NonTerminal.STOP_STATEMENT, new GotoAction(24));
        actions.put(NonTerminal.INC_STATEMENT, new GotoAction(27));
        actions.put(NonTerminal.DEC_STATEMENT, new GotoAction(28));
        ...
        actions.put(TokenType.NOT, new ShiftAction(85));
        actions.put(TokenType.AND, new ShiftAction(86));
        actions.put(TokenType.OR, new ShiftAction(87));
        actions.put(TokenType.XOR, new ShiftAction(88));
        ...
        actions.put(TokenType.NOT, new ReduceAction(44));
        ...
        actions.put(TokenType.NOT, new ReduceAction(45));
        actions.put(TokenType.AND, new ReduceAction(45));
        actions.put(TokenType.OR, new ReduceAction(45));
        actions.put(TokenType.XOR, new ReduceAction(45));
        actions.put(TokenType.EQ, new ReduceAction(45));
        actions.put(TokenType.BIGGER, new ReduceAction(45));
        actions.put(TokenType.LESS, new ReduceAction(45));
        actions.put(TokenType.BIGGER_EQ, new ReduceAction(45));
        actions.put(TokenType.LESS_EQ, new ReduceAction(45));
        actions.put(TokenType.DIF, new ReduceAction(45));
        ...
        actions.put(TokenType.NOT, new ReduceAction(46));
        actions.put(TokenType.AND, new ReduceAction(46));
        actions.put(TokenType.OR, new ReduceAction(46));
        actions.put(TokenType.XOR, new ReduceAction(46));
        actions.put(TokenType.EQ, new ShiftAction(91));
        actions.put(TokenType.BIGGER, new ShiftAction(92));
        actions.put(TokenType.LESS, new ShiftAction(93));
        actions.put(TokenType.BIGGER_EQ, new ShiftAction(94));
        actions.put(TokenType.LESS_EQ, new ShiftAction(95));
        actions.put(TokenType.DIF, new ShiftAction(96));
        actions.put(TokenType.SUM, new ShiftAction(97));
        actions.put(TokenType.SUB, new ShiftAction(98));
        actions.put(TokenType.MULT, new ShiftAction(99));
        actions.put(TokenType.DIV, new ShiftAction(100));
        actions.put(NonTerminal.RELATIONAL_STATEMENT_LINE, new GotoAction(89));
        actions.put(NonTerminal.ARITHMETIC_STATEMENT_LINE, new GotoAction(90));
        ...
        actions.put(TokenType.LESS_EQ, new ShiftAction(95));
        actions.put(TokenType.DIF, new ShiftAction(96));
        actions.put(NonTerminal.RELATIONAL_STATEMENT_LINE, new GotoAction(101));
        ...
        actions.put(TokenType.NOT, new ReduceAction(43));
        ...
        actions.put(TokenType.MULT, new ShiftAction(99));
        actions.put(TokenType.DIV, new ShiftAction(100));
        actions.put(NonTerminal.ARITHMETIC_STATEMENT_LINE, new GotoAction(102));
        ...
        actions.put(TokenType.PRINT, new ShiftAction(35));
        actions.put(TokenType.SCAN, new ShiftAction(36));
        actions.put(NonTerminal.BODY_STATEMENT, new GotoAction(103));
        actions.put(NonTerminal.WHILE_STATEMENT, new GotoAction(21));
        actions.put(NonTerminal.STOP_STATEMENT, new GotoAction(24));
        actions.put(NonTerminal.INC_STATEMENT, new GotoAction(27));
        actions.put(NonTerminal.DEC_STATEMENT, new GotoAction(28));
        ...
        // State 74
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ShiftAction(104));
        table.put(74, actions);


        // State 75
        actions = new HashMap<>();
        actions.put(TokenType.SEMICOLON, new ShiftAction(105));
        actions.put(TokenType.EQ, new ShiftAction(91));
        actions.put(TokenType.BIGGER, new ShiftAction(92));
        actions.put(TokenType.LESS, new ShiftAction(93));
        actions.put(TokenType.BIGGER_EQ, new ShiftAction(94));
        ...
        // State 77
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_PAR, new ShiftAction(106));
        table.put(77, actions);


        // State 78
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_PAR, new ShiftAction(107));
        table.put(78, actions);


        // State 79
        actions = new HashMap<>();
        actions.put(TokenType.SEMICOLON, new ShiftAction(108));
        table.put(79, actions);


        // State 80
        actions = new HashMap<>();
        actions.put(TokenType.NUM, new ShiftAction(109));
        table.put(80, actions);


        // State 81
        actions = new HashMap<>();
        actions.put(TokenType.OPEN_BRACES, new ShiftAction(110));
        table.put(81, actions);


        // State 82
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ShiftAction(111));
        table.put(82, actions);


        // State 83
        actions = new HashMap<>();
        actions.put(TokenType.OPEN_BRACES, new ReduceAction(28));
        ...
        actions.put(TokenType.NOT, new ReduceAction(47));
        actions.put(TokenType.AND, new ReduceAction(47));
        actions.put(TokenType.OR, new ReduceAction(47));
        actions.put(TokenType.XOR, new ReduceAction(47));
        ...
        actions.put(TokenType.NUM, new ShiftAction(72));
        actions.put(NonTerminal.OPERATOR, new GotoAction(70));
        actions.put(NonTerminal.OPERATOR_BOOLEAN, new GotoAction(112));
        actions.put(NonTerminal.LOGICAL_STATEMENT, new GotoAction(68));
        actions.put(NonTerminal.RELATIONAL_STATEMENT, new GotoAction(67));
        actions.put(NonTerminal.ARITHMETIC_STATEMENT, new GotoAction(71));
        ...
        actions.put(TokenType.NUM, new ShiftAction(72));
        actions.put(NonTerminal.OPERATOR, new GotoAction(70));
        actions.put(NonTerminal.OPERATOR_BOOLEAN, new GotoAction(113));
        actions.put(NonTerminal.LOGICAL_STATEMENT, new GotoAction(68));
        actions.put(NonTerminal.RELATIONAL_STATEMENT, new GotoAction(67));
        actions.put(NonTerminal.ARITHMETIC_STATEMENT, new GotoAction(71));
        ...
        actions.put(TokenType.NUM, new ShiftAction(72));
        actions.put(NonTerminal.OPERATOR, new GotoAction(70));
        actions.put(NonTerminal.OPERATOR_BOOLEAN, new GotoAction(114));
        actions.put(NonTerminal.LOGICAL_STATEMENT, new GotoAction(68));
        actions.put(NonTerminal.RELATIONAL_STATEMENT, new GotoAction(67));
        actions.put(NonTerminal.ARITHMETIC_STATEMENT, new GotoAction(71));
        ...
        actions.put(TokenType.NUM, new ShiftAction(72));
        actions.put(NonTerminal.OPERATOR, new GotoAction(70));
        actions.put(NonTerminal.OPERATOR_BOOLEAN, new GotoAction(115));
        actions.put(NonTerminal.LOGICAL_STATEMENT, new GotoAction(68));
        actions.put(NonTerminal.RELATIONAL_STATEMENT, new GotoAction(67));
        actions.put(NonTerminal.ARITHMETIC_STATEMENT, new GotoAction(71));
        ...
        actions.put(TokenType.NOT, new ReduceAction(54));
        ...
        actions.put(TokenType.EQ, new ReduceAction(54));
        actions.put(TokenType.BIGGER, new ReduceAction(54));
        actions.put(TokenType.LESS, new ReduceAction(54));
        actions.put(TokenType.BIGGER_EQ, new ReduceAction(54));
        actions.put(TokenType.LESS_EQ, new ReduceAction(54));
        actions.put(TokenType.DIF, new ReduceAction(54));
        ...
        actions.put(TokenType.NOT, new ReduceAction(61));
        ...
        actions.put(TokenType.NUM, new ShiftAction(124));
        actions.put(TokenType.CLOSE_PAR, new ReduceAction(69));
        actions.put(TokenType.NOT, new ReduceAction(69));
        actions.put(TokenType.AND, new ReduceAction(69));
        actions.put(TokenType.OR, new ReduceAction(69));
        actions.put(TokenType.XOR, new ReduceAction(69));
        actions.put(TokenType.EQ, new ReduceAction(69));
        actions.put(TokenType.BIGGER, new ReduceAction(69));
        actions.put(TokenType.LESS, new ReduceAction(69));
        actions.put(TokenType.BIGGER_EQ, new ReduceAction(69));
        actions.put(TokenType.LESS_EQ, new ReduceAction(69));
        actions.put(TokenType.DIF, new ReduceAction(69));
        actions.put(NonTerminal.ARITHMETIC_STATEMENT_LINE_LINE, new GotoAction(122));
        ...
        actions.put(TokenType.LESS_EQ, new ReduceAction(69));
        actions.put(TokenType.DIF, new ReduceAction(69));
        actions.put(NonTerminal.ARITHMETIC_STATEMENT_LINE_LINE, new GotoAction(125));
        ...
        actions.put(TokenType.LESS_EQ, new ReduceAction(69));
        actions.put(TokenType.DIF, new ReduceAction(69));
        actions.put(NonTerminal.ARITHMETIC_STATEMENT_LINE_LINE, new GotoAction(126));
        ...
        actions.put(TokenType.LESS_EQ, new ReduceAction(69));
        actions.put(TokenType.DIF, new ReduceAction(69));
        actions.put(NonTerminal.ARITHMETIC_STATEMENT_LINE_LINE, new GotoAction(127));
        ...
        actions.put(TokenType.NOT, new ReduceAction(53));
        ...
        actions.put(TokenType.NOT, new ReduceAction(62));
        ...
        // State 103
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ShiftAction(128));
        table.put(103, actions);


        // State 104
        actions = new HashMap<>();
        actions.put(TokenType.WHILE, new ShiftAction(129));
        table.put(104, actions);


        // State 105
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ReduceAction(70));
        actions.put(TokenType.ID, new ReduceAction(70));
        actions.put(TokenType.WHILE, new ReduceAction(70));
        actions.put(TokenType.STOP, new ReduceAction(70));
        actions.put(TokenType.INC, new ReduceAction(70));
        actions.put(TokenType.DEC, new ReduceAction(70));
        actions.put(TokenType.DO, new ReduceAction(70));
        actions.put(TokenType.IF, new ReduceAction(70));
        actions.put(TokenType.SWITCH, new ReduceAction(70));
        actions.put(TokenType.CASE, new ReduceAction(70));
        actions.put(TokenType.DFLT, new ReduceAction(70));
        actions.put(TokenType.PRINT, new ReduceAction(70));
        actions.put(TokenType.SCAN, new ReduceAction(70));
        table.put(105, actions);


        // State 106
        actions = new HashMap<>();
        actions.put(TokenType.SEMICOLON, new ShiftAction(130));
        table.put(106, actions);


        // State 107
        actions = new HashMap<>();
        actions.put(TokenType.SEMICOLON, new ShiftAction(131));
        ...
        actions.put(TokenType.DOUBLE, new ShiftAction(16));
        actions.put(TokenType.STRING, new ShiftAction(17));
        actions.put(NonTerminal.VAR_DECLARATION, new GotoAction(132));
        actions.put(NonTerminal.VAR_TYPE, new GotoAction(14));
        ...
        // State 109
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_SIZE_STRING, new ShiftAction(133));
        table.put(109, actions);


        // State 110
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ReduceAction(38));
        actions.put(TokenType.CASE, new ShiftAction(135));
        actions.put(TokenType.DFLT, new ShiftAction(136));
        actions.put(NonTerminal.CASE_STATEMENT, new GotoAction(134));
        ...
        actions.put(TokenType.ID, new ReduceAction(32));
        actions.put(TokenType.WHILE, new ReduceAction(32));
        actions.put(TokenType.STOP, new ReduceAction(32));
        actions.put(TokenType.INC, new ReduceAction(32));
        actions.put(TokenType.DEC, new ReduceAction(32));
        actions.put(TokenType.DO, new ReduceAction(32));
        actions.put(TokenType.IF, new ReduceAction(32));
        actions.put(TokenType.ELSE, new ShiftAction(138));
        actions.put(TokenType.SWITCH, new ReduceAction(32));
        actions.put(TokenType.CASE, new ReduceAction(32));
        actions.put(TokenType.DFLT, new ReduceAction(32));
        actions.put(TokenType.PRINT, new ReduceAction(32));
        actions.put(TokenType.SCAN, new ReduceAction(32));
        actions.put(NonTerminal.ELSE_IF_STATEMENT, new GotoAction(137));
        ...
        actions.put(TokenType.NOT, new ReduceAction(55));
        ...
        actions.put(TokenType.NOT, new ReduceAction(56));
        ...
        actions.put(TokenType.NOT, new ReduceAction(57));
        ...
        actions.put(TokenType.NOT, new ReduceAction(58));
        ...
        actions.put(TokenType.NOT, new ReduceAction(59));
        ...
        actions.put(TokenType.NOT, new ReduceAction(60));
        actions.put(TokenType.AND, new ReduceAction(60));
        actions.put(TokenType.OR, new ReduceAction(60));
        actions.put(TokenType.XOR, new ReduceAction(60));
        actions.put(TokenType.EQ, new ShiftAction(91));
        actions.put(TokenType.BIGGER, new ShiftAction(92));
        actions.put(TokenType.LESS, new ShiftAction(93));
        actions.put(TokenType.BIGGER_EQ, new ShiftAction(94));
        ...
        actions.put(TokenType.NOT, new ReduceAction(63));
        ...
        actions.put(TokenType.CLOSE_PAR, new ReduceAction(67));
        actions.put(TokenType.NOT, new ReduceAction(67));
        actions.put(TokenType.AND, new ReduceAction(67));
        actions.put(TokenType.OR, new ReduceAction(67));
        actions.put(TokenType.XOR, new ReduceAction(67));
        actions.put(TokenType.EQ, new ReduceAction(67));
        actions.put(TokenType.BIGGER, new ReduceAction(67));
        actions.put(TokenType.LESS, new ReduceAction(67));
        actions.put(TokenType.BIGGER_EQ, new ReduceAction(67));
        actions.put(TokenType.LESS_EQ, new ReduceAction(67));
        actions.put(TokenType.DIF, new ReduceAction(67));
        ...
        actions.put(TokenType.CLOSE_PAR, new ReduceAction(68));
        actions.put(TokenType.NOT, new ReduceAction(68));
        actions.put(TokenType.AND, new ReduceAction(68));
        actions.put(TokenType.OR, new ReduceAction(68));
        actions.put(TokenType.XOR, new ReduceAction(68));
        actions.put(TokenType.EQ, new ReduceAction(68));
        actions.put(TokenType.BIGGER, new ReduceAction(68));
        actions.put(TokenType.LESS, new ReduceAction(68));
        actions.put(TokenType.BIGGER_EQ, new ReduceAction(68));
        actions.put(TokenType.LESS_EQ, new ReduceAction(68));
        actions.put(TokenType.DIF, new ReduceAction(68));
        ...
        actions.put(TokenType.NOT, new ReduceAction(64));
        ...
        actions.put(TokenType.NOT, new ReduceAction(65));
        actions.put(TokenType.AND, new ReduceAction(65));
        actions.put(TokenType.OR, new ReduceAction(65));
        actions.put(TokenType.XOR, new ReduceAction(65));
        actions.put(TokenType.EQ, new ReduceAction(65));
        actions.put(TokenType.BIGGER, new ReduceAction(65));
        actions.put(TokenType.LESS, new ReduceAction(65));
        actions.put(TokenType.BIGGER_EQ, new ReduceAction(65));
        actions.put(TokenType.LESS_EQ, new ReduceAction(65));
        actions.put(TokenType.DIF, new ReduceAction(65));
        ...
        actions.put(TokenType.NOT, new ReduceAction(66));
        actions.put(TokenType.AND, new ReduceAction(66));
        actions.put(TokenType.OR, new ReduceAction(66));
        actions.put(TokenType.XOR, new ReduceAction(66));
        actions.put(TokenType.EQ, new ReduceAction(66));
        actions.put(TokenType.BIGGER, new ReduceAction(66));
        actions.put(TokenType.LESS, new ReduceAction(66));
        actions.put(TokenType.BIGGER_EQ, new ReduceAction(66));
        actions.put(TokenType.LESS_EQ, new ReduceAction(66));
        actions.put(TokenType.DIF, new ReduceAction(66));
        ...
        actions.put(TokenType.ID, new ReduceAction(24));
        actions.put(TokenType.WHILE, new ReduceAction(24));
        actions.put(TokenType.STOP, new ReduceAction(24));
        actions.put(TokenType.INC, new ReduceAction(24));
        actions.put(TokenType.DEC, new ReduceAction(24));
        actions.put(TokenType.DO, new ReduceAction(24));
        actions.put(TokenType.IF, new ReduceAction(24));
        actions.put(TokenType.SWITCH, new ReduceAction(24));
        actions.put(TokenType.CASE, new ReduceAction(24));
        actions.put(TokenType.DFLT, new ReduceAction(24));
        actions.put(TokenType.PRINT, new ReduceAction(24));
        actions.put(TokenType.SCAN, new ReduceAction(24));
        ...
        actions = new HashMap<>();
        actions.put(TokenType.OPEN_PAR, new ShiftAction(54));
        actions.put(NonTerminal.CONDITION, new GotoAction(139));
        table.put(129, actions);


        // State 130
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ReduceAction(39));
        actions.put(TokenType.ID, new ReduceAction(39));
        actions.put(TokenType.WHILE, new ReduceAction(39));
        actions.put(TokenType.STOP, new ReduceAction(39));
        actions.put(TokenType.INC, new ReduceAction(39));
        actions.put(TokenType.DEC, new ReduceAction(39));
        actions.put(TokenType.DO, new ReduceAction(39));
        actions.put(TokenType.IF, new ReduceAction(39));
        actions.put(TokenType.SWITCH, new ReduceAction(39));
        actions.put(TokenType.CASE, new ReduceAction(39));
        actions.put(TokenType.DFLT, new ReduceAction(39));
        actions.put(TokenType.PRINT, new ReduceAction(39));
        actions.put(TokenType.SCAN, new ReduceAction(39));
        table.put(130, actions);


        // State 131
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ReduceAction(40));
        actions.put(TokenType.ID, new ReduceAction(40));
        actions.put(TokenType.WHILE, new ReduceAction(40));
        actions.put(TokenType.STOP, new ReduceAction(40));
        actions.put(TokenType.INC, new ReduceAction(40));
        actions.put(TokenType.DEC, new ReduceAction(40));
        actions.put(TokenType.DO, new ReduceAction(40));
        actions.put(TokenType.IF, new ReduceAction(40));
        actions.put(TokenType.SWITCH, new ReduceAction(40));
        actions.put(TokenType.CASE, new ReduceAction(40));
        actions.put(TokenType.DFLT, new ReduceAction(40));
        actions.put(TokenType.PRINT, new ReduceAction(40));
        actions.put(TokenType.SCAN, new ReduceAction(40));
        ...
        // State 134
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ShiftAction(140));
        table.put(134, actions);


        // State 135
        actions = new HashMap<>();
        actions.put(TokenType.ID, new ShiftAction(141));
        table.put(135, actions);


        // State 136
        actions = new HashMap<>();
        actions.put(TokenType.DOUBLE_DOT, new ShiftAction(142));
        ...
        actions.put(TokenType.ID, new ReduceAction(34));
        actions.put(TokenType.WHILE, new ReduceAction(34));
        actions.put(TokenType.STOP, new ReduceAction(34));
        actions.put(TokenType.INC, new ReduceAction(34));
        actions.put(TokenType.DEC, new ReduceAction(34));
        actions.put(TokenType.DO, new ReduceAction(34));
        actions.put(TokenType.IF, new ReduceAction(34));
        actions.put(TokenType.ELSE, new ShiftAction(144));
        actions.put(TokenType.SWITCH, new ReduceAction(34));
        actions.put(TokenType.CASE, new ReduceAction(34));
        actions.put(TokenType.DFLT, new ReduceAction(34));
        actions.put(TokenType.PRINT, new ReduceAction(34));
        actions.put(TokenType.SCAN, new ReduceAction(34));
        actions.put(NonTerminal.ELSE_STATEMENT, new GotoAction(143));
        table.put(137, actions);


        // State 138
        actions = new HashMap<>();
        actions.put(TokenType.IF, new ShiftAction(145));
        table.put(138, actions);


        // State 139
        actions = new HashMap<>();
        actions.put(TokenType.SEMICOLON, new ShiftAction(146));
        ...
        actions.put(TokenType.INC, new ReduceAction(35));
        actions.put(TokenType.DEC, new ReduceAction(35));
        ...
        actions.put(TokenType.CASE, new ReduceAction(35));
        actions.put(TokenType.DFLT, new ReduceAction(35));
        ...
        // State 143
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ReduceAction(30));
        ...
        actions.put(TokenType.INC, new ReduceAction(30));
        actions.put(TokenType.DEC, new ReduceAction(30));
        ...
        actions.put(TokenType.CASE, new ReduceAction(30));
        actions.put(TokenType.DFLT, new ReduceAction(30));
        ...
        // State 144
        actions = new HashMap<>();
        actions.put(TokenType.OPEN_BRACES, new ShiftAction(149));
        ...
        actions = new HashMap<>();
        actions.put(TokenType.OPEN_PAR, new ShiftAction(54));
        actions.put(NonTerminal.CONDITION, new GotoAction(150));
        table.put(145, actions);


        // State 146
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ReduceAction(29));
        ...
        actions.put(TokenType.INC, new ReduceAction(29));
        actions.put(TokenType.DEC, new ReduceAction(29));
        ...
        actions.put(TokenType.CASE, new ReduceAction(29));
        actions.put(TokenType.DFLT, new ReduceAction(29));
        ...
        actions.put(TokenType.PRINT, new ShiftAction(35));
        actions.put(TokenType.SCAN, new ShiftAction(36));
        actions.put(NonTerminal.BODY_STATEMENT, new GotoAction(151));
        actions.put(NonTerminal.WHILE_STATEMENT, new GotoAction(21));
        actions.put(NonTerminal.STOP_STATEMENT, new GotoAction(24));
        actions.put(NonTerminal.INC_STATEMENT, new GotoAction(27));
        actions.put(NonTerminal.DEC_STATEMENT, new GotoAction(28));
        ...
        // State 148
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ReduceAction(37));
        ...
        // State 150
        actions = new HashMap<>();
        actions.put(TokenType.OPEN_BRACES, new ShiftAction(153));
        ...
        actions.put(TokenType.CASE, new ShiftAction(135));
        actions.put(TokenType.DFLT, new ShiftAction(136));
        actions.put(NonTerminal.CASE_STATEMENT, new GotoAction(154));
        table.put(151, actions);


        // State 152
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ShiftAction(155));
        ...
        actions.put(TokenType.PRINT, new ShiftAction(35));
        actions.put(TokenType.SCAN, new ShiftAction(36));
        actions.put(NonTerminal.BODY_STATEMENT, new GotoAction(156));
        actions.put(NonTerminal.WHILE_STATEMENT, new GotoAction(21));
        actions.put(NonTerminal.STOP_STATEMENT, new GotoAction(24));
        actions.put(NonTerminal.INC_STATEMENT, new GotoAction(27));
        actions.put(NonTerminal.DEC_STATEMENT, new GotoAction(28));
        ...
        actions.put(TokenType.ID, new ReduceAction(33));
        actions.put(TokenType.WHILE, new ReduceAction(33));
        actions.put(TokenType.STOP, new ReduceAction(33));
        actions.put(TokenType.INC, new ReduceAction(33));
        actions.put(TokenType.DEC, new ReduceAction(33));
        actions.put(TokenType.DO, new ReduceAction(33));
        actions.put(TokenType.IF, new ReduceAction(33));
        actions.put(TokenType.SWITCH, new ReduceAction(33));
        actions.put(TokenType.CASE, new ReduceAction(33));
        actions.put(TokenType.DFLT, new ReduceAction(33));
        actions.put(TokenType.PRINT, new ReduceAction(33));
        actions.put(TokenType.SCAN, new ReduceAction(33));
        table.put(155, actions);


        // State 156
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ShiftAction(157));
        ...
        actions.put(TokenType.PRINT, new ReduceAction(32));
        actions.put(TokenType.SCAN, new ReduceAction(32));
        actions.put(NonTerminal.ELSE_IF_STATEMENT, new GotoAction(158));
        table.put(157, actions);


        // State 158
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ReduceAction(31));
        ...
        actions.put(TokenType.INC, new ReduceAction(31));
        actions.put(TokenType.DEC, new ReduceAction(31));
        actions.put(TokenType.DO, new ReduceAction(31));
        actions.put(TokenType.IF, new ReduceAction(31));
        actions.put(TokenType.ELSE, new ReduceAction(31));
        actions.put(TokenType.SWITCH, new ReduceAction(31));
        actions.put(TokenType.CASE, new ReduceAction(31));
        actions.put(TokenType.DFLT, new ReduceAction(31));
