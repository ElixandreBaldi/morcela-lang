...
public class LRTable extends HashMap<Integer, HashMap<Operable, Action>> {
    ...
    private static LRTable fill(LRTable table) {
        ...
        // State 17
        actions = new HashMap<>();
        actions.put(TokenType.DOUBLE_DOT, new ReduceAction(12));
        ...
        actions.put(TokenType.STRING_VALUE, new ShiftAction(69));
        actions.put(TokenType.NOT, new ShiftAction(66));
        actions.put(NonTerminal.WHILE_STATEMENT_LINE, new GotoAction(70));
        actions.put(NonTerminal.OPERATOR, new GotoAction(72));
        actions.put(NonTerminal.LOGICAL_STATEMENT, new GotoAction(71));
        actions.put(NonTerminal.RELATIONAL_STATEMENT, new GotoAction(73));
        ...
        actions.put(TokenType.STRING_VALUE, new ShiftAction(69));
        actions.put(TokenType.NOT, new ShiftAction(66));
        actions.put(NonTerminal.OPERATOR, new GotoAction(76));
        actions.put(NonTerminal.LOGICAL_STATEMENT, new GotoAction(78));
        actions.put(NonTerminal.RELATIONAL_STATEMENT, new GotoAction(79));
        actions.put(NonTerminal.ARITHMETIC_STATEMENT, new GotoAction(77));
        actions.put(NonTerminal.ATTRIBUTION_STATEMENT_LINE, new GotoAction(75));
        ...
        actions.put(TokenType.NUM, new ShiftAction(67));
        actions.put(TokenType.STRING_VALUE, new ShiftAction(69));
        actions.put(NonTerminal.OPERATOR, new GotoAction(80));
        table.put(57, actions);


        // State 58
        actions = new HashMap<>();
        actions.put(TokenType.ID, new ShiftAction(81));
        table.put(58, actions);


        // State 59
        actions = new HashMap<>();
        actions.put(TokenType.SEMICOLON, new ShiftAction(84));
        actions.put(TokenType.OPEN_SIZE_STRING, new ShiftAction(85));
        actions.put(NonTerminal.VAR_DECLARATION_LINE, new GotoAction(82));
        actions.put(NonTerminal.SIZE_DECLARATION, new GotoAction(83));
        ...
        // State 61
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_PAR, new ShiftAction(86));
        ...
        // State 63
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_PAR, new ShiftAction(88));
        ...
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_PAR, new ShiftAction(88));
        actions.put(NonTerminal.IF_STATEMENT_LINE_LINE, new GotoAction(89));
        ...
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_PAR, new ShiftAction(88));
        actions.put(TokenType.AND, new ShiftAction(93));
        actions.put(TokenType.OR, new ShiftAction(94));
        actions.put(TokenType.XOR, new ShiftAction(95));
        actions.put(TokenType.EQ, new ShiftAction(96));
        actions.put(TokenType.BIGGER, new ShiftAction(97));
        actions.put(TokenType.LESS, new ShiftAction(98));
        actions.put(TokenType.BIGGER_EQ, new ShiftAction(99));
        actions.put(TokenType.LESS_EQ, new ShiftAction(100));
        actions.put(TokenType.DIF, new ShiftAction(101));
        actions.put(NonTerminal.IF_STATEMENT_LINE_LINE, new GotoAction(90));
        actions.put(NonTerminal.LOGICAL_STATEMENT_LINE, new GotoAction(91));
        actions.put(NonTerminal.RELATIONAL_STATEMENT_LINE, new GotoAction(92));
        ...
        actions.put(TokenType.NUM, new ShiftAction(67));
        actions.put(TokenType.STRING_VALUE, new ShiftAction(69));
        actions.put(NonTerminal.OPERATOR, new GotoAction(102));
        table.put(66, actions);


        // State 67
        actions = new HashMap<>();
        actions.put(TokenType.DOUBLE_DOT, new ReduceAction(48));
        actions.put(TokenType.SEMICOLON, new ReduceAction(48));
        actions.put(TokenType.CLOSE_PAR, new ReduceAction(48));
        actions.put(TokenType.AND, new ReduceAction(48));
        actions.put(TokenType.OR, new ReduceAction(48));
        actions.put(TokenType.XOR, new ReduceAction(48));
        ...
        actions.put(TokenType.SUM, new ReduceAction(48));
        actions.put(TokenType.SUB, new ReduceAction(48));
        actions.put(TokenType.MULT, new ReduceAction(48));
        actions.put(TokenType.DIV, new ReduceAction(48));
        table.put(67, actions);


        // State 68
        actions = new HashMap<>();
        actions.put(TokenType.DOUBLE_DOT, new ReduceAction(49));
        ...
        // State 69
        actions = new HashMap<>();
        actions.put(TokenType.DOUBLE_DOT, new ReduceAction(50));
        ...
        // State 71
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_PAR, new ShiftAction(104));
        actions.put(NonTerminal.WHILE_STATEMENT_LINE_LINE, new GotoAction(103));
        ...
        actions.put(TokenType.LESS_EQ, new ShiftAction(100));
        actions.put(TokenType.DIF, new ShiftAction(101));
        actions.put(NonTerminal.WHILE_STATEMENT_LINE_LINE, new GotoAction(105));
        actions.put(NonTerminal.LOGICAL_STATEMENT_LINE, new GotoAction(91));
        actions.put(NonTerminal.RELATIONAL_STATEMENT_LINE, new GotoAction(92));
        ...
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_PAR, new ShiftAction(104));
        actions.put(NonTerminal.WHILE_STATEMENT_LINE_LINE, new GotoAction(106));
        table.put(73, actions);


        // State 74
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ShiftAction(107));
        ...
        actions.put(TokenType.LESS_EQ, new ShiftAction(100));
        actions.put(TokenType.DIF, new ShiftAction(101));
        actions.put(TokenType.SUM, new ShiftAction(109));
        actions.put(TokenType.SUB, new ShiftAction(110));
        actions.put(TokenType.MULT, new ShiftAction(111));
        actions.put(TokenType.DIV, new ShiftAction(112));
        actions.put(NonTerminal.LOGICAL_STATEMENT_LINE, new GotoAction(91));
        actions.put(NonTerminal.RELATIONAL_STATEMENT_LINE, new GotoAction(92));
        actions.put(NonTerminal.ARITHMETIC_STATEMENT_LINE, new GotoAction(108));
        ...
        // State 80
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_PAR, new ShiftAction(113));
        table.put(80, actions);


        // State 81
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_PAR, new ShiftAction(114));
        ...
        // State 83
        actions = new HashMap<>();
        actions.put(TokenType.SEMICOLON, new ShiftAction(115));
        ...
        actions.put(TokenType.DOUBLE, new ShiftAction(16));
        actions.put(TokenType.STRING, new ShiftAction(17));
        actions.put(NonTerminal.VAR_DECLARATION, new GotoAction(116));
        actions.put(NonTerminal.VAR_TYPE, new GotoAction(14));
        ...
        // State 85
        actions = new HashMap<>();
        actions.put(TokenType.NUM, new ShiftAction(117));
        table.put(85, actions);


        // State 86
        actions = new HashMap<>();
        actions.put(TokenType.OPEN_BRACES, new ShiftAction(118));
        ...
        // State 88
        actions = new HashMap<>();
        actions.put(TokenType.OPEN_BRACES, new ShiftAction(119));
        ...
        actions.put(TokenType.NUM, new ShiftAction(67));
        actions.put(TokenType.STRING_VALUE, new ShiftAction(69));
        actions.put(NonTerminal.OPERATOR, new GotoAction(125));
        ...
        actions.put(TokenType.NUM, new ShiftAction(67));
        actions.put(TokenType.STRING_VALUE, new ShiftAction(69));
        actions.put(NonTerminal.OPERATOR, new GotoAction(126));
        ...
        // State 104
        actions = new HashMap<>();
        actions.put(TokenType.OPEN_BRACES, new ShiftAction(129));
        ...
        // State 107
        actions = new HashMap<>();
        actions.put(TokenType.WHILE, new ShiftAction(130));
        ...
        actions.put(TokenType.NUM, new ShiftAction(67));
        actions.put(TokenType.STRING_VALUE, new ShiftAction(69));
        actions.put(NonTerminal.OPERATOR, new GotoAction(131));
        ...
        actions.put(TokenType.NUM, new ShiftAction(67));
        actions.put(TokenType.STRING_VALUE, new ShiftAction(69));
        actions.put(NonTerminal.OPERATOR, new GotoAction(132));
        ...
        actions.put(TokenType.NUM, new ShiftAction(67));
        actions.put(TokenType.STRING_VALUE, new ShiftAction(69));
        actions.put(NonTerminal.OPERATOR, new GotoAction(133));
        ...
        actions.put(TokenType.NUM, new ShiftAction(67));
        actions.put(TokenType.STRING_VALUE, new ShiftAction(69));
        actions.put(NonTerminal.OPERATOR, new GotoAction(134));
        ...
        actions.put(TokenType.DOUBLE, new ShiftAction(16));
        actions.put(TokenType.STRING, new ShiftAction(17));
        actions.put(NonTerminal.VAR_DECLARATION, new GotoAction(135));
        actions.put(NonTerminal.VAR_TYPE, new GotoAction(14));
        ...
        // State 116
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ReduceAction(9));
        table.put(116, actions);


        // State 117
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_SIZE_STRING, new ShiftAction(136));
        ...
        actions.put(TokenType.CASE, new ShiftAction(138));
        actions.put(TokenType.DFLT, new ShiftAction(139));
        actions.put(NonTerminal.CASE_STATEMENT, new GotoAction(137));
        ...
        actions.put(TokenType.SCAN, new ShiftAction(35));
        actions.put(TokenType.PRINT, new ShiftAction(34));
        actions.put(NonTerminal.BODY_STATEMENT, new GotoAction(140));
        actions.put(NonTerminal.WHILE_STATEMENT, new GotoAction(21));
        actions.put(NonTerminal.INC_STATEMENT, new GotoAction(27));
        actions.put(NonTerminal.DEC_STATEMENT, new GotoAction(28));
        actions.put(NonTerminal.DO_WHILE_STATEMENT, new GotoAction(22));
        ...
        actions.put(TokenType.SCAN, new ShiftAction(35));
        actions.put(TokenType.PRINT, new ShiftAction(34));
        actions.put(NonTerminal.BODY_STATEMENT, new GotoAction(141));
        actions.put(NonTerminal.WHILE_STATEMENT, new GotoAction(21));
        actions.put(NonTerminal.INC_STATEMENT, new GotoAction(27));
        actions.put(NonTerminal.DEC_STATEMENT, new GotoAction(28));
        actions.put(NonTerminal.DO_WHILE_STATEMENT, new GotoAction(22));
        ...
        // State 136
        actions = new HashMap<>();
        actions.put(TokenType.SEMICOLON, new ReduceAction(13));
        ...
        actions.put(TokenType.NUM, new ShiftAction(67));
        actions.put(TokenType.STRING_VALUE, new ShiftAction(69));
        actions.put(NonTerminal.OPERATOR, new GotoAction(144));
        table.put(138, actions);


        // State 139
        actions = new HashMap<>();
        actions.put(TokenType.DOUBLE_DOT, new ShiftAction(145));
        table.put(139, actions);


        // State 140
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ShiftAction(146));
        ...
        actions.put(TokenType.STRING_VALUE, new ShiftAction(69));
        actions.put(TokenType.NOT, new ShiftAction(66));
        actions.put(NonTerminal.DO_WHILE_STATEMENT_LINE, new GotoAction(148));
        actions.put(NonTerminal.OPERATOR, new GotoAction(150));
        actions.put(NonTerminal.LOGICAL_STATEMENT, new GotoAction(149));
        ...
        // State 144
        actions = new HashMap<>();
        actions.put(TokenType.DOUBLE_DOT, new ShiftAction(151));
        ...
        actions.put(TokenType.ELSE, new ShiftAction(154));
        actions.put(NonTerminal.ELSE_STATEMENT, new GotoAction(153));
        ...
        // State 149
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_PAR, new ShiftAction(155));
        table.put(149, actions);


        // State 150
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_PAR, new ShiftAction(156));
        actions.put(TokenType.AND, new ShiftAction(93));
        actions.put(TokenType.OR, new ShiftAction(94));
        actions.put(TokenType.XOR, new ShiftAction(95));
        actions.put(NonTerminal.LOGICAL_STATEMENT_LINE, new GotoAction(91));
        ...
        actions.put(TokenType.SCAN, new ShiftAction(35));
        actions.put(TokenType.PRINT, new ShiftAction(34));
        actions.put(NonTerminal.BODY_STATEMENT, new GotoAction(157));
        actions.put(NonTerminal.WHILE_STATEMENT, new GotoAction(21));
        actions.put(NonTerminal.INC_STATEMENT, new GotoAction(27));
        actions.put(NonTerminal.DEC_STATEMENT, new GotoAction(28));
        actions.put(NonTerminal.DO_WHILE_STATEMENT, new GotoAction(22));
        ...
        actions.put(TokenType.CASE, new ShiftAction(138));
        actions.put(TokenType.DFLT, new ShiftAction(139));
        actions.put(NonTerminal.CASE_STATEMENT, new GotoAction(159));
        ...
        // State 159
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ReduceAction(44));
        table.put(159, actions);


        // State 160
        actions = new HashMap<>();
        actions.put(TokenType.CLOSE_BRACES, new ShiftAction(161));
