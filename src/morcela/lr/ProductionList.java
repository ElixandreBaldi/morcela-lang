...
public class ProductionList extends HashMap<Integer, Production> {
    ...
    public static ProductionList getInstance() {
        ...
        list.put(12, new Production(0, NonTerminal.SIZE_DECLARATION));
        ...
        list.put(32, new Production(0, NonTerminal.ELSE_IF_STATEMENT));
        list.put(33, new Production(4, NonTerminal.ELSE_STATEMENT));
        list.put(34, new Production(0, NonTerminal.ELSE_STATEMENT));
        ...
        list.put(38, new Production(0, NonTerminal.CASE_STATEMENT));
        ...
        list.put(52, new Production(0, NonTerminal.LOGICAL_STATEMENT_LINE));
        ...
        list.put(69, new Production(0, NonTerminal.ARITHMETIC_STATEMENT_LINE_LINE));
